...
<!-- <div ng-repeat='(name, note) in notes | filter:searchNotes | filter:activeNotes'> -->
		...
		<ul class='meal-list' ng-repeat='meal in meals'>
			<li class='meal-list__item'> <a class='meal-list__item-link' href=""> hi {{ meal.name }} </a> </li>
		</ul>
	...
	<div class='col-7 l-block'>
		...
		<h2 class='headline meal-headline'>Add New Meal</h2>
		...
		<div class='row'>
			<div class='col-12 l-block'>
				<div class='form-row'>
					<label for='ingredient'>Add an ingredient: <small>(hit enter/return key to add)</small></label>  
